...
@Slf4j
public class SubmitMessageValidationTests {

	@Test
	public void validate_submit_sequencing_read_happy_path() throws Exception {
		val errors = validate("schemas/submit-sequencingread-single.json", "payloads/submit-sequencingread-valid.json");
		assertThat(errors.size()).isEqualTo(0);
	}

	@Test
	public void validate_submit_sequencing_read_missing_required() throws Exception {
		val errors = validate("schemas/submit-sequencingread-single.json", "payloads/submit-sequencingread-missing-required.json");
		assertThat(errors.size()).isEqualTo(2);
	}
	
	@Test
	public void validate_submit_sequencing_read_invalid_enum() throws Exception {
		val errors = validate("schemas/submit-sequencingread-single.json", "payloads/submit-sequencingread-invalid-enum.json");
		assertThat(errors.size()).isEqualTo(4);
	}
	
	@Test
	public void validate_submit_variant_call_happy_path() throws Exception {
		val errors = validate("schemas/submit-variantcall-single.json", "payloads/submit-variantcall-valid.json");
		assertThat(errors.size()).isEqualTo(0);
	}

	@Test
	public void validate_submit_variant_call_missing_required() throws Exception {
		val errors = validate("schemas/submit-variantcall-single.json", "payloads/submit-variantcall-missing-required.json");
		assertThat(errors.size()).isEqualTo(3);
	}
	
	@Test
	public void validate_submit_variant_call_invalid_enum() throws Exception {
		val errors = validate("schemas/submit-variantcall-single.json", "payloads/submit-variantcall-invalid-enum.json");
		assertThat(errors.size()).isEqualTo(4);
	}
