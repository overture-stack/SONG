...
public class DeserializationTests {
  ...
  public void test() throws JsonParseException, JsonMappingException, IOException {
    val is = Thread.currentThread().getContextClassLoader()
        .getResourceAsStream("documents/register-sequencingread-valid.json");
  ...
  public void test_read_donor_json() throws JsonParseException, JsonMappingException, IOException {
    /*
     * { "donorSubmitterId": "Patient A", "donorGender": "male", "specimens": [ { "specimenSubmitterId": "Specimen A-1",
     * "specimenClass": "Normal", "specimenType": "Normal - solid tissue", "samples": [ { "sampleSubmitterId":
     * "Sample A1-a", "sampleType": "DNA", "files": [ { "fileName": "A1a.bam", "fileSize": 100200300, "fileType": "BAM",
    ...
    val reader = mapper.readerFor(Donor.class);
    val obj = reader.readValue(json);

    val writer = mapper.writerFor(Donor.class);
  ...
  public void test_read_study() throws JsonParseException, JsonMappingException, IOException {
    ...
    val reader = mapper.readerFor(Study.class);
    val node = mapper.reader().readTree(studyJson);
  ...
  public void test_read_doc() throws JsonParseException, JsonMappingException, IOException {
    ...
    val studyReader = mapper.readerFor(Study.class);
