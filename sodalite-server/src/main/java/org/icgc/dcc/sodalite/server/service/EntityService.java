...
public class EntityService {
	...
	public String getEntityById(String id) {
		...
		switch(type) {
			case DONOR_ID_PREFIX: return json(donorService.getById(id));
			case SPECIMEN_ID_PREFIX: return json(specimenService.getById(id));
			case SAMPLE_ID_PREFIX: return json(sampleService.getById(id));
			case FILE_ID_PREFIX: return json(fileService.getById(id));
	...
	public String update(String studyId, String json) {
		...
		for(JsonNode n: root) {
			...
			switch(type) {
				case DONOR_ID_PREFIX: donorService.update(mapper.convertValue(n,Donor.class));break;
				case SPECIMEN_ID_PREFIX:  specimenService.update(mapper.convertValue(n, Specimen.class));break;
				case SAMPLE_ID_PREFIX:  sampleService.update(mapper.convertValue(n, Sample.class));break;
				case FILE_ID_PREFIX:  fileService.update(mapper.convertValue(n, File.class));break;
				default: return "Error: Unknown ID type"+type;
			}
	...
	String deleteId(String id) {
		...
		switch(type) {
			case DONOR_ID_PREFIX: return donorService.delete(id);
			case SPECIMEN_ID_PREFIX: return specimenService.delete(id);
			case SAMPLE_ID_PREFIX: return sampleService.delete(id);
			case FILE_ID_PREFIX: return fileService.delete(id);
			default: return "Error: Unknown ID type"+type;
		}
	}
}
