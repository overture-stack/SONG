...
public abstract class AbstractEntityService<T extends Entity> {
  ...
  /***
   * This abstract class doesn't work when using jdbi created interface objects as repositories. They fail with a null
   * pointer exception when called by this class, but they don't fail when called directly.
   * 
   * This class is still slightly useful for keeping the other Entity related service classes organized; they all
   * implement the same methods with their own repositories.
   */
