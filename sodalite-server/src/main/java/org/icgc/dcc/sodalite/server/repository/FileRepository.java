...
public interface FileRepository {
  ...
  int save(@Bind("id") String id, @Bind("study_id") String studyId, @Bind("sample_id") String sampleId, @Bind("name") String name,
  ...
  int update(@Bind("id") String id, @Bind("study_id") String studyId, @Bind("sample_id") String sampleId, @Bind("name") String name, @Bind("size") Long size, @Bind("file_type") String fileType,
