...
public interface FileRepository {
  ...
  int create(@Bind("id") String id, @Bind("sample_id") String sample_id, @Bind("name") String name,
  ...
  int update(@Bind("id") String id, @Bind("name") String name, @Bind("size") Long size,
  ...
  List<File> readByParentId(@Bind("sample_id") String sample_id);
