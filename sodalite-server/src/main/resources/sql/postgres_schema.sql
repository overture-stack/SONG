...
CREATE TABLE IF NOT EXISTS Study (id VARCHAR(36) PRIMARY KEY, name TEXT, description TEXT, organization TEXT, auth_service_base_url VARCHAR(255), id_service_base_url VARCHAR(255), info TEXT);

CREATE TABLE IF NOT EXISTS Donor (id VARCHAR(16) PRIMARY KEY, study_id VARCHAR(36) references Study, submitted_id TEXT, gender GENDER, info TEXT);

CREATE TABLE IF NOT EXISTS Specimen (id VARCHAR(16) PRIMARY KEY, donor_id VARCHAR(16) references Donor, submitted_id TEXT, class SPECIMEN_CLASS, type SPECIMEN_TYPE, info TEXT);

CREATE TABLE IF NOT EXISTS Sample(id VARCHAR(16) PRIMARY KEY, specimen_id VARCHAR(16) references Specimen, submitted_id TEXT, type SAMPLE_TYPE, info TEXT);
