...
insert into variant_call_analysis(id, study_id, state, variant_calling_tool) values ('AN1', 'ABC123', 'SUPPRESSED', 'SuperNewVariantCallingTool');
insert into variant_call_fileset(id, analysis_id, file_id) values ('FS1','AN1','FI1'),('FS2','AN1','FI2');
insert into sequencing_read_analysis (id, study_id, state, library_strategy, paired_end, insert_size, aligned, alignment_tool, reference_genome) values ('AN2','ABC123','SUPPRESSED', 'Other', TRUE, 12345, TRUE, 'BigWrench', 'hg19');
insert into sequencing_read_fileset(id, analysis_id, file_id) values ('FS3','AN2', 'FI1'),('FS4','AN2','FI3');
insert into maf_analysis(id, study_id) values ('MU1','ABC123');
insert into maf_fileset(id, analysis_id, file_id) values ('FS3', 'MU1', 'FI1'),('FS5','MU1','FI2'),('FS6','MU1','FI3');