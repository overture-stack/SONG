# -*- coding: utf-8 -*-
#
# song documentation build configuration file, created by
...
#
#rtisma html_theme = 'alabaster'
#rtisma html_theme = 'classic'
...
latex_documents = [
    (master_doc, 'song.tex', u'song Documentation',
...
man_pages = [
    (master_doc, 'song', u'song Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'song', u'song Documentation',
     author, 'song', 'One line description of project.',
     'Miscellaneous'),
]
