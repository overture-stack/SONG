...
echo '$AUTH_SERVER_PREFIX='$AUTH_SERVER_PREFIX
echo '$AUTH_SERVER_SUFFIX='$AUTH_SERVER_SUFFIX
...
$ID_HOME/bin/dcc-id-server start \
	...
	set.AUTH_SERVER_PREFIX=$AUTH_SERVER_PREFIX \
	set.AUTH_SERVER_SUFFIX=$AUTH_SERVER_SUFFIX
