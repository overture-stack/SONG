...
public class EnforcedUploadControllerTest extends AbstractEnforcedTester {
  ...
  public void enforceLatestSubmit_NonLatest_AnalysisTypeIncorrectVersion(){
    ...
    // Assert that submitting the payload while enforceLatest=true results in an ANALYSIS_TYPE_INCORRECT_VERSION
    getEndpointTester().submitPostRequestAnd(getStudyId(), payload)
