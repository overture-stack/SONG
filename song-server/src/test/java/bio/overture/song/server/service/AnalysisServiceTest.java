...
public class AnalysisServiceTest {
  ...
  public void testReadVariantCallDNE() {
    ...
    assertSongError(
        () -> service.securedDeepRead(analysis.getStudy(), analysisId), VARIANT_CALL_NOT_FOUND);
  ...
  public void testReadSequencingReadDNE() {
    ...
    assertSongError(
        () -> service.securedDeepRead(analysis.getStudy(), analysisId), SEQUENCING_READ_NOT_FOUND);
  ...
  public void testAnalysisMissingFilesException() {
    ...
    assertSongError(
        () -> service.securedReadFiles(analysis1.getStudy(), analysisId1), ANALYSIS_MISSING_FILES);
    ...
    assertSongError(
        () -> service.securedReadFiles(analysis2.getStudy(), analysisId2), ANALYSIS_MISSING_FILES);
  }
