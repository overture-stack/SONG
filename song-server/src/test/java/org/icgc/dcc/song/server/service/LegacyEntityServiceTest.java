...
import static org.icgc.dcc.song.server.service.LegacyEntityService.createLegacyEntityService;
...
public class LegacyEntityServiceTest {
  ...
  @Mock
  private LegacyEntityRepository repository;
  ...
  public static void initClass(){
    ...
    LEGACY_ENTITY_DATA = stream(jsonData)
  ...
  public void testGetMissingEntity(){
    val id = "FI-DNE";
    assertSongError(() -> service.getEntity(id), LEGACY_ENTITY_NOT_FOUND);
  }
  ...
  public void testFindByGnosId(){
    ...
    val searchProbe = LegacyDto.builder()
        .gnosId(gnosId)
        .build();
  ...
  public void testIllegalQuery(){
    ...
    for(val fieldName : parameterChecker.getFieldNamesFor(LegacyDto.class)){
      ...
      assertSongError(() -> service.find(params,  dummyProbe, DEFAULT_PAGEABLE), ILLEGAL_QUERY_PARAMETER );
    }
  }
  ...
  public void testIllegalFilter(){
    ...
    for(val fieldName : parameterChecker.getFieldNamesFor(LegacyDto.class)){
      ...
      assertSongError(() -> service.find(params,  dummyProbe, DEFAULT_PAGEABLE), ILLEGAL_FILTER_PARAMETER );
    }
  }
  ...
  private MultiValueMap<String, String> createParams(String queryField, String queryValue, List<String> filteredFields ){
  ...
  private void setupRepositoryFindAll(LegacyEntity probe, Pageable pageable, Predicate<LegacyEntity> expectedFilter){
    val entities = LEGACY_ENTITY_DATA.stream()
  ...
  private void setupService(){
    parameterChecker = createParameterChecker(LegacyEntity.class, LegacyDto.class);
