...
public class DonorService {
  ...
  public String create(@NonNull DonorWithSpecimens donorWithSpecimens) {
    ...
    donorWithSpecimens
        .getSpecimens()
        .forEach(s -> specimenService.create(donorWithSpecimens.getStudyId(), s));
    return id;
  }
  ...
  public Donor unsecuredRead(@NonNull String id) {
    ...
    checkServer(
        donorResult.isPresent(),
        getClass(),
        DONOR_DOES_NOT_EXIST,
        "The donor for donorId '%s' could not be read because it does not exist",
        id);
  ...
  public List<DonorWithSpecimens> readByParentId(@NonNull String parentId) {
    ...
    val ids =
        donorRepository.findAllByStudyId(parentId).stream()
  ...
  public void checkDonorExists(@NonNull String id) {
    checkServer(
        ...
        this.getClass(),
        DONOR_DOES_NOT_EXIST,
        "The donor with donorId '%s' does not exist",
        id);
  }
  ...
  public void checkDonorDoesNotExist(@NonNull String id) {
    checkServer(
        ...
        "The donor with donorId '%s' already exists",
        id);
  }
  ...
  // TODO: [SONG-254] DeleteByParentId spec missing --
  // https://github.com/overture-stack/SONG/issues/254
