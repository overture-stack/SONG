...
public class JWTTokenConverter extends JwtAccessTokenConverter {
  ...
  public OAuth2Authentication extractAuthentication(Map<String, ?> map) {
    ...
    // TODO: rtisma --- this is also a hack. the resourceIds maps to the "aud" field. This should be empty inorder for the OAuth2AuthenticationManager to process properly
