...
public class FullView {
  ...
  public static final String VARIANTCALL_MATCHED_NORMAL_SAMPLE_SUBMITTER_ID =
      "variantcall_matched_normal_sample_submitter_id";
  public static final String VARIANTCALL_TUMOUR_SAMPLE_SUBMITTER_ID =
      "variantcall_tumour_sample_submitter_id";
