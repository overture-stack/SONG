...
import bio.overture.song.client.register.Endpoint2.ListAnalysisTypesRequest;
...
public class Registry2 {
  ...
  private final Endpoint2 endpoint;
  private final String studyId;
  private final String serverUrl;

  @Autowired
  public Registry2(@NonNull Config config, @NonNull RestClient2 restClient) {
    this.restClient = restClient;
    this.endpoint = new Endpoint2();
