...
import static bio.overture.song.sdk.command.rules.ModeRule.createModeRule;
...
import bio.overture.song.sdk.command.rules.ModeRule;
import bio.overture.song.sdk.command.rules.ParamTerm;
import bio.overture.song.sdk.command.rules.RuleProcessor;
